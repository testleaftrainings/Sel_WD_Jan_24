...
public class ReadExcel {
	...
	//public static void main(String[] args)
		public  String[][] excelData(String excelName) throws IOException {
			//set the file path
			                                   //./excel/CreateLead.xlsx
			XSSFWorkbook book=new XSSFWorkbook("./excel/"+excelName+".xlsx");
